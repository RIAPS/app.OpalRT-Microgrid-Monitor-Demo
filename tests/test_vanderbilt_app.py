...
def test_cli():
    ...
    if True:
        required_clients = ['172.21.20.50', '172.21.20.51', '172.21.20.52', '172.21.20.20']
        app_folder = pathlib.Path(__file__).parents[1]
        c.setAppFolder(app_folder)
        app_name = c.compileApplication("appMgManage_single_feeder.riaps", app_folder)
        depl_file = "appMgManage_single_feeder_vanderbilt.depl"
